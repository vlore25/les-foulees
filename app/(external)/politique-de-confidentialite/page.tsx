...
export const metadata: Metadata = {
  title: "Politique de Confidentialité | Les Foulées Avrillaises",
  description: "Politique de confidentialité et gestion des données de l'association Les Foulées Avrillaises."
};
