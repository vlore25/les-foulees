...
import { CalendarIcon, Check, ChevronDownIcon, ChevronLeft, ChevronRight } from 'lucide-react'
    ...
    <div className="w-full max-w-lg mx-auto">
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-2">
            ...
            {/* Ligne de connexion grise derrière */}
      ...
      <form action={action} className="flex flex-col gap-6 min-h-[400px]"> 
        ...
        <div className={cn("space-y-4", currentStep === 2 ? "block" : "hidden")}>
             ...
             {/* Affichage des erreurs globales à la dernière étape */}
